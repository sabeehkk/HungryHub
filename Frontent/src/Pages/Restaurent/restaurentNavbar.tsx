 ...
 <div className="md:mt-5  bg-gradient-to-r from-red-400 to-yellow-500 py-4 p-3  top-0 sticky z-50 shadow shadow-gray-200"> 
  <div className="container mx-auto my-3 flex items-center justify-between">
      ...
      <nav id="nav-items" className="space-x-4 md:block hidden">
        <Link to={'/restaurent/home'} className="text-gray-950 hover:text-white">
          HOME
        </Link>
...
{success ? 
<Link className="text-gray-950 hover:text-yellow-500" to={'/restaurent/logout'}>Logout</Link>: 
<Link className="text-gray-950 hover:text-yellow-500" to={'/restaurent/login'}>Login / Register</Link>
}
