...
const BillModal = ({ isOpen, closeModal, orderItem } :any) => {
  ...
  const formattedDate = new Date(orderItem.createdAt).toLocaleDateString(
    "en-GB",
    {
      day: "2-digit",
      month: "2-digit",
  ...
  useEffect(() => {
    if (!restaurant.restaurent || !restaurant.restaurent._id) {
      ...
      restaurentAxios
        .get(`/getResProfile?id=${restaurant_id}`)
        .then((response) => {
            ...
            <div className="justify-between font-semibold italic">
              <div>
                ...
                <div className="pt-7">
                  ...
                  <div>
                    {orderItem &&
                    orderItem.employeeId &&
                    orderItem.employeeId ? (
                      <div>
                        <h1 className="italic">
                          Name : {orderItem.employeeId.Name}
                        </h1>
                        <h1 className="italic">
                          Contact : {orderItem.employeeId.Mobile}
                        </h1>
                      </div>
                    ) : (
                      <div>Address information not available.</div>
